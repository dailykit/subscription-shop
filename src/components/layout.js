        ...
        <div>
            ...
            {hasConfig("Contact", "brand") && (
              <>
                <span tw="mt-4 flex items-center">
                  ...
                  <a
                    href={`mailto:${configOf("Contact", "brand")?.email}`}
                    tw="underline"
                  >
          ...
          <section>
            ...
            <ul>
              ...
              {isAuthenticated && (
                <li tw="mb-3">
                  <Link href="/subscription/account/profile/">Profile</Link>
                </li>
              )}
              <li tw="mb-3">
                <Link href="/subscription/menu">Menu</Link>
              </li>
            </ul>
          </section>
          {(isTermsAndConditionsAvailable ||
            ...
            <section>
              ...
              <ul>
                ...
                {isPrivacyPolicyAvailable && (
                  <li tw="mb-3">
                    <Link href="/subscription/privacy-policy/">
                      Privacy Policy
                    </Link>
                  </li>
                )}
                {isRefundPolicyAvailable && (
                  <li tw="mb-3">
                    <Link href="/subscription/refund-policy/">
                      Refund Policy
                    </Link>
                  </li>
                )}
